  ...
  return (
    ...
    >
      <h1 className="tt-title">
        ...
        <span className="tt-title-total">({productLength})</span>
      </h1>
      ...
      <div className="tt-quantity">
        {/* {windowSize <= 790 && (
          <button
            className={`tt-col-one tt-show ${
              layout === "tt-col-one" ? "active" : ""
            }`}
        ...
        {windowSize <= 1024 && (
          <button
            className={`tt-col-two tt-show ${
              layout === "tt-col-two" ? "active" : ""
            }`}
        ...
        {windowSize > 1024 && (
          <Fragment>
            {/* <button
              className={`tt-col-four tt-show ${
                layout === "tt-col-four" ? "active" : ""
              }`}
              onClick={() => getLayout("tt-col-four")}
            /> */}
            {/* {!sidebar && (
              <button
                className={`tt-col-six tt-show ${
                  layout === "tt-col-six" ? "active" : ""
                }`}
